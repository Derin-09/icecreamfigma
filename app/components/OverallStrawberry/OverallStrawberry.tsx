...
import SideImage from '@/public/image/bgStrawberry.png'
import Choose from '@/public/image/Choose your taste.png'
import DetailsStrawberry from '../details/DetailsStrawberry'
import NavbarStrawberry from '../navbar/NavbarStrawberry'
import PictureStrawberry from '../picture/PictureStrawberry'


const OverallStrawberry = () => {
  return (
...
export default OverallStrawberry